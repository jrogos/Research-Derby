...
PARcs_df <- read.csv("Output/PAR_clear_sky.RDS", header = T) # comes from file "GlobalIrradiance.R"
...
WQ_PAR_cone <- WQ_PAR_cone  %>% mutate(PP_depth = PPdepth_func(PPmax = PPmax, daylength = daylight,
...
plot(PP_WQ_PAR_cone$date[PP_WQ_PAR_cone$depth2 == 1 & PP_WQ_PAR_cone$year == 2015 & PP_WQ_PAR_cone$doy.y >= 182 & PP_WQ_PAR_cone$doy.y <= 250],
     PP_WQ_PAR_cone$PPmax[PP_WQ_PAR_cone$depth2 == 1 & PP_WQ_PAR_cone$year == 2015 & PP_WQ_PAR_cone$doy.y >= 182 & PP_WQ_PAR_cone$doy.y <= 250],
     type = "l", ylab = "Daily phytoplankton production (g C m-2)", xlab = "Dates",
     ylim = c(-0.01,10))
lines(PP_WQ_PAR_cone$date[PP_WQ_PAR_cone$depth2 == 10 & PP_WQ_PAR_cone$year == 2015 & PP_WQ_PAR_cone$doy.y >= 182 & PP_WQ_PAR_cone$doy.y <= 250],
      PP_WQ_PAR_cone$PPmax[PP_WQ_PAR_cone$depth2 == 10 & PP_WQ_PAR_cone$year == 2015 & PP_WQ_PAR_cone$doy.y >= 182 & PP_WQ_PAR_cone$doy.y <= 250],
      col = "blue")
lines(PP_WQ_PAR_cone$date[PP_WQ_PAR_cone$depth2 == 30 & PP_WQ_PAR_cone$year == 2015 & PP_WQ_PAR_cone$doy.y >= 182 & PP_WQ_PAR_cone$doy.y <= 250],
      PP_WQ_PAR_cone$PPmax[PP_WQ_PAR_cone$depth2 == 30 & PP_WQ_PAR_cone$year == 2015 & PP_WQ_PAR_cone$doy.y >= 182 & PP_WQ_PAR_cone$doy.y <= 250],
      col = "red")

max(WQ.QC$depth)

plot(PP_WQ_PAR_cone$depth2[PP_WQ_PAR_cone$year == 2015 & PP_WQ_PAR_cone$doy.y == 182][35:89],
     PP_WQ_PAR_cone$PPmax[PP_WQ_PAR_cone$year == 2015 & PP_WQ_PAR_cone$doy.y == 182][35:89],
...
plot(PP_WQ_PAR_cone$depth2[PP_WQ_PAR_cone$year == 2015 & PP_WQ_PAR_cone$doy.y == 182][90:144],
     PP_WQ_PAR_cone$PPmax[PP_WQ_PAR_cone$year == 2015 & PP_WQ_PAR_cone$doy.y == 182][90:144],
